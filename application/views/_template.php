					...
					<div class="card-box">
						<div class="card-header clearfix">
							<div class="card-title clearfix">
								...
								<button type="button" onclick="openaddModal()"  class="btn btn-primary"><i class="fa fa-plus"></i> New Template</button>
							</div>
						</div><br>
...
<!--										<label>Template Name</label><br>-->
						...
						<div class="modal-footer" id="template_footer">
							...
							<button id="create_template" class="btn btn-primary pull-right" type="button"  onclick="CreateTemplate()"><i class="fa fa-save"></i>Save</button>
						</div>
					</div>
				</div>
			</div>
...
<script>
	$(document).ready(function(){
		...
		$("#btn_add_more").click(function () {
			...
			var more_field = '<div class="row new_attr_row">\n' +
				...
				'<button type="button" onclick="remove_div(this);" class="btn btn-danger remove_row"><i class="fa fa-times"></i></button>\n' +
				'</div>\n' +
				'</div>';
	...
	function openaddModal(){
		...
		$("#template_footer").append('<button id="create_template" class="btn btn-primary pull-right" type="button"  onclick="CreateTemplate()"><i class="fa fa-save"></i>Save</button>');
	...
	function editfun(template_id){
		...
		app.request(baseURL + "edittemplate",formData).then(res=>{
			...
			if(res.status == 200){
				...
				$('div#template_detail_div').empty();
				$("#create_template").remove();
				$("#template_footer").append('<button id="create_template" class="btn btn-primary pull-right" type="button"  onclick="updateTemplate()"><i class="fa fa-save"></i>Update</button>');
