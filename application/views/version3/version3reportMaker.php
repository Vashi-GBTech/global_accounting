				...
				<div class="col-lg-12">
					<div class="card-box" style="border: none">
						<div class="row m-b-10">
							...
							<div class="col-md-4" >
								<select name="filterIND" id="filterIND" class="form-control" onchange="GetReportView1(1,'reportMakerTableIND',1);GetReportView1(1,'reportMakerTableIND2',2);">
						...
						<button type="button" class="btn btn-info tabClass" data-toggle="collapse" data-target="#mainReportIND" id="" onclick="GetReportView1(1,'reportMakerTableIND',1)">Main Report</button>
						...
						<button type="button" class="btn btn-success tabClass m-t-5" data-toggle="collapse" data-target="#scheduleReportIND" id="" onclick="GetReportView1(1,'reportMakerTableIND2',2)">Schedule Report</button>
				...
				<div class="col-lg-12">
					<div class="card-box" style="border: none">
						<div class="row m-b-10">
							...
							<div class="col-md-4" >
								<select name="filterUSD" id="filterUSD" class="form-control" onchange="GetReportView1(2,'reportMakerTableUSD2',1);GetReportView1(2,'reportMakerTableUSD',2);">
									<option value="1" selected>Active</option>
									<option value="2">Inactive</option>
									<option value="0" >All</option>
								</select>
						...
						<button type="button" class="btn btn-info tabClass" data-toggle="collapse" data-target="#mainReportUSD" id="" onclick="GetReportView1(2,'reportMakerTableUSD2',1)">Main Report</button>
						...
						<button type="button" class="btn btn-success tabClass m-t-5" data-toggle="collapse" data-target="#scheduleReportUSD" id="" onclick="GetReportView1(2,'reportMakerTableUSD',2)">Schedule Report</button>
				...
				<div class="col-lg-12">
					<div class="card-box" style="border: none">
						<div class="row m-b-10">
							...
							<div class="col-md-4" >
								<select name="filterIFRS" id="filterIFRS" class="form-control" onchange="GetReportView1(3,'reportMakerTableIFRS',1);GetReportView1(3,'reportMakerTableIFRS2',2);">
									<option value="1" selected>Active</option>
									<option value="2">Inactive</option>
									<option value="0" >All</option>
								</select>
						...
						<button type="button" class="btn btn-info tabClass" data-toggle="collapse" data-target="#mainReportIFRS" id="" onclick="GetReportView1(3,'reportMakerTableIFRS',1)">Main Report</button>
						...
						<button type="button" class="btn btn-success tabClass m-t-5" data-toggle="collapse" data-target="#scheduleReportIFRS" id="" onclick="GetReportView1(3,'reportMakerTableIFRS2',2)">Schedule Report</button>
...
<script type="text/javascript">
	$(document).ready(function () {
		GetReportView1(1,'reportMakerTableIND',1);
	});
