...
<html lang="en">
  <head>
    ...
    <link href="<?= base_url() ?>assets/css/bootstrap-colorpicker.min.css" rel="stylesheet">
  ...
  <body>
    ...
    <script src="<?= base_url() ?>assets/js/jquery.ui.rotatable.min.js"></script>
    <script src="<?= base_url() ?>assets/js/bootstrap.min.js"></script>
    <script src="<?= base_url() ?>assets/js/debounce.js"></script>
    <script src="<?= base_url() ?>assets/js/bootstrap-colorpicker.min.js"></script>
	<script src="<?= base_url() ?>assets/js/creative.tools.js"></script>
