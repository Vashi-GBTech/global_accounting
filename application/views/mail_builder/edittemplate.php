...
<html lang="en">
  <head>
    ...
    }('/application/views/mail_builder/'));
    ...
    <?=include_style('mail_assets/css/bootstrap.min.css'); ?>
    <link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/smoothness/jquery-ui.css">
	<?=include_style('mail_assets/css/bootstrap-colorpicker.min.css'); ?>
    <?=include_style('mail_assets/css/bootstrap-slider.min.css'); ?>
    <?=include_style('mail_assets/plugins/medium-editor/medium-editor.min.css'); ?>
	<?=include_style('mail_assets/plugins/medium-editor/template.min.css'); ?>
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/spectrum/1.8.0/spectrum.min.css">
    <?=include_style('mail_assets/css/style.css'); ?>
  ...
  <body>
    <div class="container-fullscreen">
        ...
        <div class="container-sidebar hidden" id="option-tabs">
			<div class="text-center" style="color:black"> 
				...
				<form id="image_form">
				<input type="file" name="image_data" id="image_data" class="form-control">
				<button type="button" class="btn btn-primary" onclick="image_upload()">Upload Image</button>
				</form>
			</div>
    ...
    <button class="btn btn-lg btn-default btn-materialize btn-left-bottom btn-left-bottom-4 hidden" type="button" id="image_button" title="Layout Options" data-toggle="tooltip" data-placement="top" data-trigger="hover">image</button>    
    <div id="alerts"></div>
    ...
    <div class="tools tools-left" id="settings">
	   ...
	   <div class="tools tools-left" id="image_button">
        <div class="tools-header">
            <button type="button" class="close" data-dismiss="tools" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4><span class="fa fa-cog fa-spin"></span> Settings</h4>
        </div>
    ...
    <script src="<?= base_url() ?>mail_assets/js/bootstrap.min.js"></script>
    <script src="<?= base_url() ?>mail_assets/js/bootbox.min.js"></script>
    <script src="<?= base_url() ?>mail_assets/js/debounce.js"></script>
    <script src="<?= base_url() ?>mail_assets/js/bootstrap-colorpicker.min.js"></script>
    <script src="<?= base_url() ?>mail_assets/js/bootstrap-slider.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/spectrum/1.8.0/spectrum.min.js"></script>
    <script src="//cdn.jsdelivr.net/medium-editor/latest/js/medium-editor.min.js"></script>
    <?=include_script('mail_assets/js/creative.tools.js'); ?>
	<?=include_script('mail_assets/js/html2canvas.js'); ?>
	<?=include_script('mail_assets/js/image-edit.js'); ?>
	<?=include_script('mail_assets/js/editor.js'); ?>
  </body>
</html>
