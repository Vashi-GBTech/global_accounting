			 ...
			 <form method="post" id="reportForm">
				 <div class="text_area">
					 <div class="file_header align-items-center borderjustify-content-between text-black-50 bg-light px-2" style="display: flex;padding-top: 15px;">
						 ...
						 <a href="<?php echo base_url();?>tableReportMakerList"><i class="close_btn fa fa-times pr-3" id="close_notepad"></i></a>
                 ...
                 <div class="col-md-4" style="height: 100vh;overflow: auto;box-shadow: 1px 1px 5px 5px lightgrey;"><br>
					 <div class="col-md-12 row mb-2" id="styleDiv" style="display: none">
						 ...
						 <span>Font Bold:</span>
						 <input id="isbold" value="1" type="checkbox">
